...
if __name__ == "__main__":
    ...
    # plt.title('Power Breakdown For Desktop')
    plt.title('Power Breakdown For Jetson')

    # plt.xticks(ind, rotation='vertical', labels=['desktop-demo','desktop-materials', 'desktop-platformer', 'desktop-sponza'])
    plt.xticks(ind, rotation='vertical', labels=['jetsonhp-demo', 'jetsonhp-materials', 'jetsonhp-platformer', 'jetsonhp-sponza', 'jetsonlp-demo', 'jetsonlp-materials', 'jetsonlp-platformer', 'jetsonlp-sponza'])
    # plt.xticks(ind, rotation='vertical', labels=['desktop-demo',	'desktop-materials', 'desktop-platformer', 'desktop-sponza', 'jetsonhp-demo', 'jetsonhp-materials', 'jetsonhp-platformer', 'jetsonhp-sponza', 'jetsonlp-demo', 'jetsonlp-materials', 'jetsonlp-platformer', 'jetsonlp-sponza'])
    plt.yticks(np.arange(0, max_y+1, max_y/10))

    plt.subplots_adjust(right=0.7, bottom=.3)
    plt.legend([x[0] for x in bar_plots[::-1]], row_names[::-1], bbox_to_anchor=(1.04,0), loc="lower left", borderaxespad=0)
    fig1 = plt.gcf()
    fig1.savefig('Test4.png')
